...
namespace Syringe.Web.Extensions.HtmlHelpers
{
	...
	{
		public static IHtmlContent GenerateHttpStatusDropdown<TModel, TProperty>(this HtmlHelper<TModel> htmlHelper, Expression<Func<TModel, TProperty>> expression, object htmlAttributes)
		{
		...
		public static IHtmlContent GenerateScriptSnippetsDropdown<TModel, TProperty>(this HtmlHelper<TModel> htmlHelper, Expression<Func<TModel, string>> propertyValueExpression, Expression<Func<TModel, TProperty>> expression, object htmlAttributes)

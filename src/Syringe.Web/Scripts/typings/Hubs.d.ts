// Autogenerated by SignalrTypescriptGenerator.exe at 23/06/2016 20:36:32
...
declare module Syringe.Service.Api.Hubs
{
	interface CompletedTaskInfo
	{
		...
		Verifications : System.Collections.Generic.List_Assertion_;
	}
}
...
{
	interface List_Assertion_
	{
		Capacity : number;
		Count : number;
		Item : Syringe.Core.Tests.Assertion;
	}
}
...
declare module Syringe.Core.Http
{
	interface HttpResponse
	{
		...
		Content : string;
		Headers : System.Collections.Generic.List_KeyValuePair_String_String__;
...
declare module System.Collections.Generic
{
	interface List_KeyValuePair_String_String__
	{
		Capacity : number;
		Count : number;
		Item : System.Collections.Generic.KeyValuePair_String_String_;
	}
}

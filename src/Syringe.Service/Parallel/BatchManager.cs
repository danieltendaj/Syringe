...
namespace Syringe.Service.Parallel
{
    public class BatchManager : IBatchManager
    {
        ...
        public BatchManager(ITestFileQueue testFileQueue, IMemoryCache objectCache, ITestFileResultFactory testFileResultFactory)
        {
        ...
        public BatchStatus GetBatchStatus(int batchId)
        {
            ...
            if (!_objectCache.TryGetValue(key, out batchInfo))
            {
